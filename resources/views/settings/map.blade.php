    ...
    <div class="pt-16 md:pt-20 px-4 sm:px-6 lg:px-8">
        <div class="py-6 max-w-screen-2xl mx-auto">
            ...
            <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
                <div class="flex items-center gap-4">
                    <a href="javascript:void(0)" onclick="returnToController()" title="Back to Homepage"
                        class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-slate-grey/10 hover:bg-slate-grey/20 dark:bg-blue-slate/30 dark:hover:bg-blue-slate/50 transition-colors focus:outline-none focus:ring-2 focus:ring-regal-navy dark:focus:ring-prussian-blue focus:ring-offset-2 dark:focus:ring-offset-prussian-blue-3 shrink-0 text-prussian-blue dark:text-lavender-grey">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                        </svg>
                    </a>
                    <div>
                        <h1 class="text-xl font-bold tracking-tight text-prussian-blue dark:text-white">Devices Map</h1>
                        <p class="mt-1 text-sm text-slate-grey dark:text-lavender-grey">Real‑time location and status of all beacons and sirens</p>
                    </div>
                </div>
                ...
                <button id="expandMapBtn"
                   ...
                   focus:outline-none focus:ring-2 focus:ring-regal-navy dark:focus:ring-prussian-blue focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-prussian-blue-3">
            ...
            <div class="flex flex-col lg:flex-row gap-6">
                <!-- Map Container -->
                <div class="flex-1 bg-white dark:bg-gray-800 rounded-lg shadow border border-slate-grey/20 dark:border-blue-slate/30 overflow-hidden h-[calc(100vh-280px)] min-h-[535px]">
                    <div id="map" class="w-full h-full"></div>
                </div>

                <!-- Summary Panel -->
                <div class="lg:w-80 bg-white dark:bg-gray-800 rounded-lg shadow border border-slate-grey/20 dark:border-blue-slate/30 overflow-hidden h-[535px] flex flex-col">
                    <div class="p-4 border-b border-slate-grey/20 dark:border-blue-slate/30 flex-shrink-0">
                        <h3 class="text-base font-semibold text-prussian-blue dark:text-white flex items-center gap-2">
                    ...
                    <div class="p-4 space-y-6 overflow-y-auto flex-1 custom-scroll">
                            ...
                            <div class="flex items-center gap-2 mb-3">
                                <div class="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
                                    <svg class="w-4 h-4 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 5v2m0 4v2m0 4v2M5 5h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z" />
                                    </svg>
                                </div>
                                <h4 class="text-sm font-semibold text-prussian-blue dark:text-white">Beacons</h4>
                            </div>
                            <div class="space-y-2">
                                <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-800">
                                    <div class="flex items-center gap-2">
                                        <span class="inline-block w-3 h-3 rounded-full bg-munti-green-1 shadow-glow"></span>
                                        <span class="text-xs text-slate-grey dark:text-lavender-grey">Online</span>
                                    </div>
                                    <span id="onlineNormalCount" class="text-sm font-semibold text-munti-green-1 dark:text-munti-green-1">0</span>
                                </div>
                                <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-800">
                                    <div class="flex items-center gap-2">
                                        <div class="relative">
                                            <span class="inline-block w-3 h-3 rounded-full bg-munti-yellow-0 shadow-glow"></span>
                                            <svg class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1.5 h-1.5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <span class="text-xs text-slate-grey dark:text-lavender-grey">Online + Door Open</span>
                                    </div>
                                    <span id="doorOpenCount" class="text-sm font-semibold text-munti-yellow-0 dark:text-munti-yellow-0">0</span>
                                </div>
                                <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-800">
                                    <div class="flex items-center gap-2">
                                        <span class="inline-block w-3 h-3 rounded-full bg-munti-red-0"></span>
                                        <span class="text-xs text-slate-grey dark:text-lavender-grey">Offline</span>
                                    </div>
                                    <span id="offlineCount" class="text-sm font-semibold text-munti-red-0 dark:text-munti-red-0">0</span>
                                </div>
                                <div class="mt-3 pt-2 border-t border-slate-grey/20 dark:border-blue-slate/30">
                                    <div class="flex items-center justify-between">
                                        <span class="text-xs font-medium text-slate-grey dark:text-lavender-grey">Total Beacons</span>
                                        <span id="totalBeacons" class="text-sm font-bold text-prussian-blue dark:text-white">0</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center gap-2 mb-3">
                                <div class="w-8 h-8 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center">
                                    <svg class="w-4 h-4 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 18v-5m0 5v5m0-10a3 3 0 100-6 3 3 0 000 6z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 9l3-3m0 0l3 3m-3-3v12" />
                                    </svg>
                                </div>
                                <h4 class="text-sm font-semibold text-prussian-blue dark:text-white">Sirens</h4>
                            </div>
                            <div class="space-y-2">
                                <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-800">
                                    <div class="flex items-center gap-2">
                                        <div class="inline-block w-0 h-0 border-l-[6px] border-r-[6px] border-b-[12px] border-l-transparent border-r-transparent" style="border-bottom-color: #84cc16;"></div>
                                        <span class="text-xs text-slate-grey dark:text-lavender-grey">Online (Standby)</span>
                                    </div>
                                    <span id="sirensOnlineCount" class="text-sm font-semibold text-munti-green-1 dark:text-munti-green-1">0</span>
                                </div>
                                <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-800">
                                    <div class="flex items-center gap-2">
                                        <div class="inline-block w-0 h-0 border-l-[6px] border-r-[6px] border-b-[12px] border-l-transparent border-r-transparent animate-pulse" style="border-bottom-color: #ef4444;"></div>
                                        <span class="text-xs text-slate-grey dark:text-lavender-grey">Active / Alerting</span>
                                    </div>
                                    <span id="sirensAlertingCount" class="text-sm font-semibold text-munti-red-0 dark:text-munti-red-0">0</span>
                                </div>
                                <div class="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-800">
                                    <div class="flex items-center gap-2">
                                        <div class="inline-block w-0 h-0 border-l-[6px] border-r-[6px] border-b-[12px] border-l-transparent border-r-transparent" style="border-bottom-color: #6b7280;"></div>
                                        <span class="text-xs text-slate-grey dark:text-lavender-grey">Offline</span>
                                    </div>
                                    <span id="sirensOfflineCount" class="text-sm font-semibold text-gray-600 dark:text-gray-400">0</span>
                                </div>
                                <div class="mt-3 pt-2 border-t border-slate-grey/20 dark:border-blue-slate/30">
                                    <div class="flex items-center justify-between">
                                        <span class="text-xs font-medium text-slate-grey dark:text-lavender-grey">Total Sirens</span>
                                        <span id="totalSirens" class="text-sm font-bold text-prussian-blue dark:text-white">0</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Last Updated -->
                        <div class="pt-4 border-t border-slate-grey/20 dark:border-blue-slate/30">
                            <div class="flex items-center justify-between text-xs text-slate-grey dark:text-lavender-grey">
                                <span>Auto-refresh every 30s</span>
                                <span id="lastUpdated" class="font-mono">Just now</span>
                            </div>
                            <button id="refreshDataBtn" 
                                class="mt-3 w-full px-3 py-2 text-xs font-medium text-center text-white bg-regal-navy dark:bg-prussian-blue hover:bg-blue-slate dark:hover:bg-blue-slate rounded-lg transition-colors">
                                Refresh Data
                            </button>
                        </div>
                    </div>
...
<style>
    ...
    .beacon-popup .online, .siren-popup .online { color: #84cc16; font-weight: bold; }
    .beacon-popup .door-open, .siren-popup .alert { color: #eab308; font-weight: bold; }
    .beacon-popup .offline, .siren-popup .offline { color: #ef4444; font-weight: bold; }
...
<script>
    (function() {
        ...
        let totalBeacons = 0;
        let onlineNormalCount = 0;
        let doorOpenCount = 0;
        let offlineCount = 0;
        let totalSirens = 0;
        let sirensOnlineCount = 0;
        let sirensAlertingCount = 0;
        let sirensOfflineCount = 0;

        function updateSummaryStats() {
            document.getElementById('totalBeacons').textContent = totalBeacons;
            document.getElementById('onlineNormalCount').textContent = onlineNormalCount;
            document.getElementById('doorOpenCount').textContent = doorOpenCount;
            document.getElementById('offlineCount').textContent = offlineCount;
            document.getElementById('totalSirens').textContent = totalSirens;
            document.getElementById('sirensOnlineCount').textContent = sirensOnlineCount;
            document.getElementById('sirensAlertingCount').textContent = sirensAlertingCount;
            document.getElementById('sirensOfflineCount').textContent = sirensOfflineCount;
        ...
        function loadBeacons(targetMap = map) {
            ...
            beacons.forEach(beacon => {
                ...
                let statusText = isOnline 
                    ? (isDoorOpen ? 'Online + Door Open' : 'Online') 
                    : (isDoorOpen ? 'Offline (door open reported)' : 'Offline');
                ...
                const statusColor = isOnline 
                    ? (isDoorOpen ? 'text-munti-yellow-0' : 'text-munti-green-1') 
                    : 'text-munti-red-0';
        ...
        function loadSirens(targetMap = map) {
            ...
            sirensOnlineCount = 0;
            sirensAlertingCount = 0;
            sirensOfflineCount = 0;

            sirens.forEach(siren => {
                const { latitude, longitude, name, location, siren_id, group, is_alerting } = siren;
                if (!latitude || !longitude) return;
                ...
                const statusLine = isOnline 
                    ...
                    : '✗ Offline';
                const statusColor = isOnline 
                    ? (isAlerting ? 'text-munti-red-0' : 'text-munti-green-1') 
                    : 'text-munti-red-0';
